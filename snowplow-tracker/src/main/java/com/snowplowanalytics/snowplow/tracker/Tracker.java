...
public class Tracker implements DiagnosticLogger {
    ...
    public static class TrackerBuilder {
         ...
         */
        @NonNull
        public TrackerBuilder subject(@NonNull Subject subject) {
         ...
         */
        @NonNull
        public TrackerBuilder base64(@NonNull Boolean base64) {
         ...
         */
        @NonNull
        public TrackerBuilder platform(@NonNull DevicePlatforms platform) {
         ...
         */
        @NonNull
        public TrackerBuilder loggerDelegate(@NonNull LoggerDelegate delegate) {
